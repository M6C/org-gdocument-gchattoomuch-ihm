...
public class MainActivity extends AccountAuthenticatorActivity implements IAuthenticationResult {
...
//	private Bundle authBundle;
    ...
    public void onCreate(Bundle data) {
		...
		((Button)findViewById(R.id.btnSendAPK)).setOnClickListener(new OnClickSendApkListenerOk(this, ConstantsService.SERVICE_INTENT_FILTER_ACTION_SEND_APK));
		((Button)findViewById(R.id.btnSendAPKP2PClient)).setOnClickListener(new OnClickSendApkListenerOk(this, ConstantsService.SERVICE_INTENT_FILTER_ACTION_SEND_APK_P2P_CLIENT));
...
//		        authTask.execute();
    ...
    public void onClickSendDb(View view) {
    	...
    	OnClickListener onClickOkListener = new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (uploadTask == null) {
					executeSmsReceiver(SmsParser.MSG_TYPE.SEND_DB, null);
					uploadTask = new WifiDatabaseDownloadTask(MainActivity.this, new Notifier()) {
						protected void onPreExecute() {
							super.onPreExecute();
							btnUpload.setText(getString(R.string.btn_text_server_stop_send_db));
						};
						protected void onPostExecute(String result) {
							btnUpload.setText(getString(R.string.btn_text_server_call_send_db));
							uploadTask = null;
    	...
    	FactoryDialog.getInstance().buildOkCancelDialog(this, onClickOkListener, R.string.app_name, R.string.btn_text_server_call_send_db).show();
    }

    public void onClickDownloadDb(View view) {
    	final Button btnUpload = (Button)view;
...
//   	}
	...
	private void logEr(String tag, String msg) {
